...
const navItems = [
  ...
  { path: '/budget', icon: budgetIcon, label: '预算' },
]
...
const budgetIcon = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>`
